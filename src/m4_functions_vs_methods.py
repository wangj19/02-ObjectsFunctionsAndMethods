...
def try_functions():
    ...
    qwe.pen = rg.Pen('red', 2)
    qwe.pen_up()
    qwe.go_to(rg.Point(200, 100))
    qwe.pen_down()
    qwe.go_to(rg.Point(300, 30))
    asd = rg.SimpleTurtle('turtle')
    asd.pen = rg.Pen('green', 2)
    asd.pen_up()
    asd.go_to(rg.Point(100, 200))
    asd.pen_down()
    asd.go_to(rg.Point(0, 0))
    zxc = rg.SimpleTurtle('turtle')
    zxc.pen = rg.Pen('grey', 2)
    zxc.pen_up()
    zxc.go_to(rg.Point(-50, 50))
    zxc.pen_down()
    zxc.go_to(rg.Point(100, 100))
    """
